...
export const GAME_QUERY_LEADERBOARDS_SCHEMA = z.object({
  request: z.object({
    head: z.object({
      function: z.enum([ApiRequestFunction.GAME_QUERY_LEADERBOARDS]),
    }),
    body: z.object({
      limit: z.number().int(),
      orderBy: z.object({
...
export type GAME_QUERY_LEADERBOARDS_TYPE = z.infer<
  typeof GAME_QUERY_LEADERBOARDS_SCHEMA
>;
